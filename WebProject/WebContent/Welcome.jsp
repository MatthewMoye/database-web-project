    ...
    <header class="w3-container w3-center" style="padding:128px 16px">
     ...
     <div class="w3-container w3-xlarge w3-center w3-padding-36" style="margin: auto;">
        <div class="w3-bar w3-padding-large">
            <a href="ViewDatabase.jsp" class="w3-button w3-black w3-padding-large w3-card-4" style=" width: 500px;">View Database</a>
        </div>
     </div>

     <div class="w3-container w3-xlarge w3-center w3-padding-large">
        <div class="w3-bar w3-padding-large">
            <a href="UpdateDatabase.jsp" class="w3-button w3-black w3-padding-large w3-card-4" style=" width: 500px;">Update Database</a>
        </div>
     </div>

     <div class="w3-container w3-xlarge w3-center w3-padding-large" style="margin: auto;">
        <div class="w3-bar w3-padding-large">
            <a href="UpdateDatabase_AddTo.jsp" class="w3-button w3-black w3-padding-large w3-card-4" style=" width: 500px;">Add To Database</a>
        </div>
     </div>
     
     <div class="w3-container w3-xlarge w3-center w3-padding-large" style="margin: auto;">
        <div class="w3-bar w3-padding-large">
            <a href="SpecialSearch.jsp" class="w3-button w3-black w3-padding-large w3-card-4" style=" width: 500px;">Special Search</a>
        </div>
     </div>

     <div class="w3-container w3-xlarge w3-center w3-padding-large">
        <div class="w3-bar w3-padding-large">
            <a href="About.jsp" class="w3-button w3-black w3-padding-large w3-card-4" style=" width: 500px;">About</a>
        </div>
     </div>
